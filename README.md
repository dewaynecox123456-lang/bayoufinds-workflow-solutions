...
Single-page static Netlify landing page for BayouFinds Workflow Solutions.
...
The discovery form uses Netlify Forms with a honeypot field. Deploy the repository to Netlify with the publish directory set to the project root.
